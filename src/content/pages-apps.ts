...
export const appPages: AppPage[] = [
  ...
  },
  {
    ...
    bodyHtmlUz: `<p>888Starz Android ilovasi sizga istalgan joyda sport stavkalarini qo'yish va kazino o'yinlarini o'ynash imkonini beradi.</p><p>Rasmiy APK faylni yuklab olish uchun: <a href="https://888starzuz.bet/apk/" rel="nofollow noopener" target="_blank" style="color:#ec4899;font-weight:600;">888starz yuklab oling</a> — bu havola orqali eng so'nggi versiyani oling.</p>`,
    bodyHtmlRu: `<p>Официальное приложение 888Starz для Android — быстрая установка и удобный интерфейс.</p><p>Скачайте по прямой ссылке: <a href="https://888starzuz.bet/apk/" rel="nofollow noopener" target="_blank" style="color:#ec4899;font-weight:600;">888starz скачать</a>. Устанавливайте только с официального источника.</p>`,
